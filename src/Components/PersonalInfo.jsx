...
const PersonalInfoContent = () => {
  return (
    <div className='flex flex-col px-20 py-16 gap-16 '>
      ...
      <div className='flex justify-start w-full pl-14 pt-16'>
         <button className="font-['Poppins'] font-normal text-white bg-[#7D794F] py-4 px-44 drop-shadow-lg focus:translate-y-1 transition ease-in-out duration-300 text-2xl hover:text-[#7D794F] hover:bg-transparent hover:border-2 hover: border-[#7D794F]">
            Save Changes
        </button>
      </div>
    </div>
