    ...
    <nav className={`fixed z-[10] w-full ${scroll > 50 && "bg-[#7D794F]"}`}>
      <div className="items-center container mx-auto w-full pl-4 py-4  grid grid-cols-3">
        ...
        <div className="flex items-center gap-8 font-['Poppins'] text-white text-base  justify-end relative">
          {/* Icon love */}
          <Link
            to="/ProfilePage/Wishlist"
            className="hover:text-[#AE9A64] hover:fill-white">
            <svg
          ...
          <button
            ...
            <svg
              ...
              <path
                fill="currentColor"
                d="m216 64l-12.2 66.9a15.9 15.9 0 0 1-15.7 13.1H62.5L48 64Z"
                opacity=".2"
              />
              <path
                fill="currentColor"
          ...
          <div className="flex flex-row gap-4 items-center group peer">
            <svg
              ...
              <path
                ...
                className=" group-hover:text-[#d4d0be]"
              />
            </svg>
            <span className=" font-['Poppins'] text-white text-base group-hover:text-[#d4d0be] active:text-[#7D794F]">
              Hi! Jasmine
            </span>
          </div>
          <div
            ...
            <Link
              to="/ProfilePage/PersonalInfo"
              className="px-5 py-3 hover:bg-gray-200">
              Personal Info
            </Link>
            <Link
              to="/ProfilePage/MyOrders"
              className="px-5 py-3 hover:bg-gray-200">
              My Orders
            </Link>
            <Link
      ...
      {showLogout ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed left-0 bg-slate-300 inset-0 z-50 outline-none focus:outline-non">
            <div className=" w-full flex justify-center h-1/2 items-center">
              <div className="relative border-0 rounded-xl shadow-lg flex flex-col h-80 w-max bg-white">
                <button className="flex justify-center pt-8 px-5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="80"
                    height="80"
                ...
                <div className="flex gap-3 pb-3 items-center justify-center font-['Poppins']">
                  <button
                    className="flex-1 bg-[#7D794F] text-white rounded-full py-2 px-10 ml-8 hover:shadow-lg hover:bg-[#A4A282]"
                    onClick={() => setShowLogout(false)}>
                    Cancel
                  </button>
                  <Link
                    to="/"
                    className="flex-1 bg-white text-[#7D794F] border-2 border-[#7D794F] rounded-full py-2 px-10 mr-8 hover:shadow-lg hover:bg-[#A4A282] hover:text-white hover:border-[#A4A282] text-center">
                    Yes
                  </Link>
                </div>
