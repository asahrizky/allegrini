    ...
    <nav className={`fixed z-[10] w-full ${scroll > 50 && "bg-[#7D794F]"}`}>
        <div className="flex justify-between items-center container mx-auto w-full pl-4 py-4 ">
            ...
            <div className="flex items-center gap-8 font-['Poppins'] text-white text-base">
                {/* Icon love */}
                <Link to='/ProfilePage/Wishlist' className="hover:text-[#AE9A64] hover:fill-white transition ease-in duration-200">
